...
public class HTMLfileHander extends BaseFileHandler{

    public HTMLfileHander(String argFilePath) throws IOException {
        super(argFilePath, "<html> <head></head> <body>", "</body></html>", "HTML файл");
    }

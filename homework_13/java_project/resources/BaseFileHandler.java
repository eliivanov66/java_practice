...
public abstract class BaseFileHandler {
    ...
    private String info;
    public BaseFileHandler(String argFilePath, String argFileStart, String argFileEnd, String argInfo) throws IOException{
        this.fileStorage = new File(argFilePath);
        if (! this.fileStorage.exists()) {
            this.fileStorage.createNewFile();
            this.Write(argFileStart);
            this.Write(argFileEnd);
        }
        this.info = argInfo;
    }
